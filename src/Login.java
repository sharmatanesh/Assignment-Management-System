...
PreparedStatement pst=null;
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "---Select Role---", "Teacher", "Student" }));
    ...
    String Password= String.valueOf(txtPassword.getPassword());
     ...
     if(jComboBox1.getSelectedItem().equals("Teacher")){
      String sql= "select * from teacher where username= '" + txtUserName.getText() + "' and password ='" + txtPassword.getText() + "'";
      try
      {
          pst=con.prepareStatement(sql);
          rs= pst.executeQuery();
          if (rs.next()){
           if(txtUserName.getText().equals(rs.getString("username"))){this.hide();
             MainMenut frm=new MainMenut(txtUserName.getText());
             frm.setVisible(true);}
            }
          else{
      ...
      String sql= "select * from student where username= '" + txtUserName.getText() + "' and password ='" + txtPassword.getText() + "'";
      try
      {
          pst=con.prepareStatement(sql);
          rs= pst.executeQuery();
          if (rs.next()){
           if(txtUserName.getText().equals(rs.getString("username"))){this.hide();
             StudentAss frm=new StudentAss(txtUserName.getText().toString());
             frm.setVisible(true);}
          }
          else{
         ...
         JOptionPane.showMessageDialog(null, e); 
          ...
          JOptionPane.showMessageDialog(this,"Please Select Your Role","Error",JOptionPane.ERROR_MESSAGE);
      }
    }                                  
